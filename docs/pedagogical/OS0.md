...
$\approx 855$-line proof is measure-theoretic *plumbing* that makes that line rigorous
...
- **The measure** $\mu \equiv \mu_{\mathrm{GFF}}$ — the mean-zero **Gaussian** probability
  ...
  ([OS/Measure/Construct.lean:143](../../OSforGFF/Measure/Construct.lean#L143)).
...
([OS/Spacetime/Basic.lean:250](../../OSforGFF/Spacetime/Basic.lean#L250)); the smeared
...
([OS/Axioms.lean:75](../../OSforGFF/OS/Axioms.lean#L75)); the free-field instance is the
headline theorem `gaussianFreeField_satisfies_OS0`
([OS/OS0_Analyticity.lean:838](../../OSforGFF/OS/OS0_Analyticity.lean#L838)), harvested as
the `os0` field of the bundled `SatisfiesAllOS (μ_GFF d m)`
([OS/Axioms.lean:194](../../OSforGFF/OS/Axioms.lean#L194)). The analyticity is in the
...
**All the length is bookkeeping.** So why is the file $\approx 855$ lines? Because two
...
([OS/OS0_Analyticity.lean:666](../../OSforGFF/OS/OS0_Analyticity.lean#L666)) is
...
([OS/Covariance/ParsevalGeneric.lean:162](../../OSforGFF/Covariance/ParsevalGeneric.lean#L162)).
...
[OS/Measure/Construct.lean:153](../../OSforGFF/Measure/Construct.lean#L153)), namely
...
[OS/OS0_Analyticity.lean:797](../../OSforGFF/OS/OS0_Analyticity.lean#L797)):
...
[OS/OS0_Analyticity.lean:808](../../OSforGFF/OS/OS0_Analyticity.lean#L808)) is
...
([OS/OS0_Analyticity.lean:821](../../OSforGFF/OS/OS0_Analyticity.lean#L821)) certifies it
...
([OS/OS0_Analyticity.lean:838](../../OSforGFF/OS/OS0_Analyticity.lean#L838)) composes with
...
## 5. The crux — where the $\approx 855$ lines go
...
([OS/OS0_Analyticity.lean:498](../../OSforGFF/OS/OS0_Analyticity.lean#L498)), and it rests
...
[OS/OS0_Analyticity.lean:200](../../OSforGFF/OS/OS0_Analyticity.lean#L200)), so over a
...
- **Fernique's theorem** (`gaussianFreeField_pairing_expSq_integrable`,
  [OS/Measure/Construct.lean:404](../../OSforGFF/Measure/Construct.lean#L404)): for the
...
and $\lvert x\rvert \le e^{\lvert x\rvert}$ soaks up the polynomial prefactor. A cascade of
lemmas exists solely to assemble this one dominator —
`gff_exp_neg_pairing_integrable`
([:218](../../OSforGFF/OS/OS0_Analyticity.lean#L218)),
`gff_exp_abs_pairing_memLp`
([:259](../../OSforGFF/OS/OS0_Analyticity.lean#L259)),
`gff_exp_abs_sum_memLp` (combining several factors by Hölder,
[:400](../../OSforGFF/OS/OS0_Analyticity.lean#L400)),
`gff_integrand_norm_integrable`
([:453](../../OSforGFF/OS/OS0_Analyticity.lean#L453)), and
`gff_integrand_integrable`
([:467](../../OSforGFF/OS/OS0_Analyticity.lean#L467)). Unglamorous — and the reason
...
> integral does the rest — that is the whole 800-line detour.
...
$\approx 855$ lines are the rigor behind *differentiating $Z$ under the integral sign* (via
...
|---|---|---|
| OS0 axiom (statement) | `OS/Axioms.lean` | `OS0_Analyticity` (75) |
| Bundled OS axioms | `OS/Axioms.lean` | `SatisfiesAllOS` (194) |
| Generating functional (GF) | `Spacetime/Basic.lean` | `GJGeneratingFunctionalℂ` (250) |
| GFF measure / dim-indexed alias | `Measure/Construct.lean` | `gaussianFreeField_free` (143) / `μ_GFF` (148) |
| Real characteristic functional (black box) | `Measure/Construct.lean` | `gff_real_characteristic` (153) |
| Fernique: $e^{\alpha x^2}$ integrable | `Measure/Construct.lean` | `gaussianFreeField_pairing_expSq_integrable` (404) |
| $\lVert e^{i\langle\omega,f\rangle}\rVert = e^{-\varphi(f_{\mathrm{im}})}$ (C) | `OS/OS0_Analyticity.lean` | `norm_exp_I_distributionPairingℂ_real` (200) |
| $e^{-\varphi(f)}$ integrable (Fernique) | `OS/OS0_Analyticity.lean` | `gff_exp_neg_pairing_integrable` (218) |
| $e^{\lvert\varphi(f)\rvert} \in L^p$ (Young + Fernique) | `OS/OS0_Analyticity.lean` | `gff_exp_abs_pairing_memLp` (259) |
| product of factors $\in L^2$ (Hölder) | `OS/OS0_Analyticity.lean` | `gff_exp_abs_sum_memLp` (400) |
| integrand norm integrable | `OS/OS0_Analyticity.lean` | `gff_integrand_norm_integrable` (453) |
| integrand integrable | `OS/OS0_Analyticity.lean` | `gff_integrand_integrable` (467) |
| slice is entire (Leibniz / diff. under $\int$) | `OS/OS0_Analyticity.lean` | `gff_cf_slice_entire` (498) |
| $Z[f] = \exp(-\tfrac12 C_{\mathbb C}(f,f))$ (A) | `OS/OS0_Analyticity.lean` | `gff_complex_CF_covariance` (666) |
| bilinear expansion | `OS/OS0_Analyticity.lean` | `freeCovarianceℂ_bilinear_sum_expansion` (797) |
| closed form for $\sum z_i J_i$ (B) | `OS/OS0_Analyticity.lean` | `gff_generating_eq_exp_quadratic` (808) |
| quadratic-form analyticity | `OS/OS0_Analyticity.lean` | `analyticOn_finite_quadratic` (821) |
| complexified covariance form | `Covariance/ParsevalGeneric.lean` | `freeCovarianceℂ_bilinear` (162) |
| **OS0 for the GFF (main)** | `OS/OS0_Analyticity.lean` | `gaussianFreeField_satisfies_OS0` (838) |
