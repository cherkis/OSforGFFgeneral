...
lemma timeTranslationSchwartzℂ_decompose_fst (s : ℝ) (g : TestFunctionℂ STDimension) :
...
lemma timeTranslationSchwartzℂ_decompose_snd (s : ℝ) (g : TestFunctionℂ STDimension) :
...
lemma timeTranslationDistribution_pairingℂ (s : ℝ) (ω : FieldConfiguration STDimension)
    (g : TestFunctionℂ STDimension) :
...
lemma continuous_distributionPairingℂ_timeTranslation (ω : FieldConfiguration STDimension)
    (g : TestFunctionℂ STDimension) :
...
def timeTranslationE (t : ℝ) : @QFT.E STDimension :=
  ⟨1, -timeShiftConst (d := STDimension) t⟩

/-- The Euclidean action of timeTranslationE equals timeTranslationSchwartzℂ. -/
lemma euclidean_action_timeTranslationE (t : ℝ) (f : TestFunctionℂ STDimension) :
...
lemma gff_mgf_formula (m : ℝ) [Fact (0 < m)] (J : TestFunctionℂ STDimension) :
...
lemma gff_generating_time_invariant (m : ℝ) [Fact (0 < m)] (s : ℝ) (f : TestFunctionℂ STDimension) :
...
lemma gff_joint_mgf_factorization (m : ℝ) [Fact (0 < m)] (f g : TestFunctionℂ STDimension) :
