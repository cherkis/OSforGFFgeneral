...
lemma euclidean_action_apply (g : @E STDimension) (f : TestFunctionℂ STDimension) (x : SpaceTime STDimension) :
...
lemma euclidean_pullback_eq_inv_act (g : @E STDimension) (x : SpaceTime STDimension) :
    euclidean_pullback g x = act g⁻¹ x := rfl

/-- Composing pullbacks: euclidean_pullback g (act g y) = y. -/
lemma euclidean_pullback_act (g : @E STDimension) (y : SpaceTime STDimension) :
...
lemma act_euclidean_pullback (g : @E STDimension) (x : SpaceTime STDimension) :
...
noncomputable def actEquiv (g : @E STDimension) : SpaceTime STDimension ≃ᵐ SpaceTime STDimension where
  toFun := act g
  invFun := act g⁻¹
...
lemma measurePreserving_actEquiv (g : @E STDimension) :
...
/-- The complex bilinear covariance form is invariant under Euclidean transformations.
    ...
    **Proof sketch:**
    ...
    5. Use MeasurePreserving.prod to get measure preservation on SpaceTime STDimension × SpaceTime STDimension
...
theorem freeCovarianceℂ_bilinear_euclidean_invariant (g : @E STDimension) (f h : TestFunctionℂ STDimension) :
