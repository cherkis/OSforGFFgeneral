...
- OS4 Ergodicity is supplied by polynomial clustering (α=2) → ergodicity
...
theorem gaussianFreeField_satisfies_all_OS_axioms (m : ℝ) [Fact (0 < m)] :
  ...
  -- OS4 Ergodicity: polynomial clustering (α=2) implies ergodicity
  os4_ergodicity := OS4_Ergodicity.OS4_PolynomialClustering_implies_OS4_Ergodicity m
    (QFT.gaussianFreeField_satisfies_OS4_PolynomialClustering m 2 (by norm_num))
