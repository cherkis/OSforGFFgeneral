...
- **OS2** (Euclidean Invariance): The measure is invariant under 2D Euclidean transformations.
...
| [`gaussian_satisfies_OS2`](../OSforGFF/GaussianFreeField.lean#L219) | `GaussianFreeField.lean` | OS2: $Z[g\cdot f] = Z[f]$ for $g \in E(2)$ |
