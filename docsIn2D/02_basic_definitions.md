...
The spacetime is $\mathbb{R}^2$ with the standard Euclidean metric, modeled as `EuclideanSpace ℝ (Fin 2)`. The coordinate index 0 is the time direction. The Euclidean symmetry group $E(2) = O(2) \rtimes \mathbb{R}^2$ acts on spacetime by rotations and translations.

Key structures:
- **Spacetime:** $\mathbb{R}^2$ with the standard Euclidean inner product.
- **Time coordinate:** The projection $x \mapsto x_0$.
- **Euclidean group:** $E(2) = O(2) \rtimes \mathbb{R}^2$ acting on spacetime and test functions.
- **Time reflection:** $\Theta: (t,\mathbf{x}) \mapsto (-t,\mathbf{x})$, a distinguished involution in $E(2)$.
- **Spacetime decomposition:** The measurable equivalence $\mathbb{R}^2 \cong \mathbb{R} \times \mathbb{R}$ separating time and spatial coordinates.
- **Positive time set:** The open half-space $\{x \in \mathbb{R}^2 : x_0 > 0\}$.

### Key Declarations (`OSforGFF/Basic.lean`)

| Declaration | Description |
|-------------|-------------|
| [`STDimension`](../OSforGFF/Basic.lean#L111) | Spacetime dimension ($= 2$) |
| [`SpaceTime`](../OSforGFF/Basic.lean#L112) | $\mathbb{R}^2 =$ `EuclideanSpace ℝ (Fin 2)` |
...
| Declaration | Description |
|-------------|-------------|
| [`O4`](../OSforGFF/Euclidean.lean#L108) | Orthogonal group $O(2)$ |
| [`QFT.E`](../OSforGFF/Euclidean.lean#L113) | Euclidean group $E(2) = O(2) \rtimes \mathbb{R}^2$ |
| [`QFT.act`](../OSforGFF/Euclidean.lean#L119) | Group action of $E(2)$ on spacetime |
| [`measurePreserving_act`](../OSforGFF/Euclidean.lean#L295) | $E(2)$ preserves Lebesgue measure |
...
| [`QFT.compTimeReflection`](../OSforGFF/DiscreteSymmetry.lean#L230) | $f \mapsto f \circ \Theta$ on $\mathcal{S}(\mathbb{R}^2,\mathbb{C})$ |
| [`QFT.compTimeReflectionReal`](../OSforGFF/DiscreteSymmetry.lean#L251) | $f \mapsto f \circ \Theta$ on $\mathcal{S}(\mathbb{R}^2,\mathbb{R})$ |

### Key Declarations (`OSforGFF/Basic.lean` — Spatial Geometry)

| Declaration | Description |
|-------------|-------------|
| [`SpatialCoords`](../OSforGFF/Basic.lean#L323) | Spatial coordinates $\mathbb{R}$ |
| [`spatialPart`](../OSforGFF/Basic.lean#L329) | Spatial projection $\mathbb{R}^2 \to \mathbb{R}$ |
...
| Declaration | Description |
|-------------|-------------|
| [`spacetimeDecomp`](../OSforGFF/SpacetimeDecomp.lean#L49) | Measurable equivalence $\mathbb{R}^2 \cong \mathbb{R} \times \mathbb{R}$ |
...
| [`positiveTimeSet`](../OSforGFF/PositiveTimeTestFunction_real.lean#L45) | $\{x \in \mathbb{R}^2 : x_0 > 0\}$ |

### Euclidean Group Structure

The Euclidean group `QFT.E` is formalized as a structure containing an orthogonal matrix $R \in O(2)$ and a translation vector $t \in \mathbb{R}^2$. The group operations are:
...
Test functions are Schwartz-class functions on $\mathbb{R}^2$, serving as the "smearing functions" that pair with distributional field configurations. The formalization uses Mathlib's `SchwartzMap` type.

Key types:
- **TestFunction:** $\mathcal{S}(\mathbb{R}^2, \mathbb{R})$
- **TestFunctionℂ:** $\mathcal{S}(\mathbb{R}^2, \mathbb{C})$
...
| Declaration | Description |
|-------------|-------------|
| [`TestFunction`](../OSforGFF/Basic.lean#L133) | $\mathcal{S}(\mathbb{R}^2, \mathbb{R})$ |
| [`TestFunctionℂ`](../OSforGFF/Basic.lean#L135) | $\mathcal{S}(\mathbb{R}^2, \mathbb{C})$ |
...
| [`distributionPairingℂ_real`](../OSforGFF/Basic.lean#L304) | $\langle\omega, f\rangle_{\mathbb{C}}$ for $f : \mathcal{S}(\mathbb{R}^2,\mathbb{C})$ |
...
| Declaration | Description |
|-------------|-------------|
| [`toComplex`](../OSforGFF/ComplexTestFunction.lean#L224) | $\mathcal{S}(\mathbb{R}^2,\mathbb{R}) \hookrightarrow \mathcal{S}(\mathbb{R}^2,\mathbb{C})$ |
| [`toComplexCLM`](../OSforGFF/ComplexTestFunction.lean#L270) | The embedding as CLM |
| [`conjSchwartz`](../OSforGFF/ComplexTestFunction.lean#L314) | $f \mapsto \bar{f}$ on $\mathcal{S}(\mathbb{R}^2,\mathbb{C})$ |
...
| Declaration | Description |
|-------------|-------------|
| [`euclidean_action`](../OSforGFF/Euclidean.lean#L407) | $E(2)$ action on $\mathcal{S}(\mathbb{R}^2,\mathbb{C})$ |
| [`euclidean_action_real`](../OSforGFF/Euclidean.lean#L415) | $E(2)$ action on $\mathcal{S}(\mathbb{R}^2,\mathbb{R})$ |
...
| [`timeTranslationSchwartz`](../OSforGFF/TimeTranslation.lean#L213) | $T_s$ on $\mathcal{S}(\mathbb{R}^2,\mathbb{R})$ |
| [`timeTranslationSchwartzℂ`](../OSforGFF/TimeTranslation.lean#L221) | $T_s$ on $\mathcal{S}(\mathbb{R}^2,\mathbb{C})$ |
...
where $G_f(t) = \int_{\mathbb{R}} \|f(t, v)\|\ dv$ is the spatial marginal.
...
| [`schwartz_vanishing_ftc_decay`](../OSforGFF/SchwartzProdIntegrable.lean#L353) | $\lvert f(t,x)\rvert \le Ct/(1+\lVert x\rVert)^2$ for positive-time-supported $f$ |
| [`spatialNormIntegral`](../OSforGFF/SchwartzProdIntegrable.lean#L308) | $G_f(t) = \int_{\mathbb{R}}\lvert f(t,x)\rvert\ dx$ |
...
| Declaration | Description |
|-------------|-------------|
| [`besselK1`](../OSforGFF/BesselFunction.lean#L47) | $K_0(z) = \int_0^\infty e^{-z\cosh t}\ dt$ |
